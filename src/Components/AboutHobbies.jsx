    ...
    return (
        <section className="about-hobbies mx-auto">
            ...
            <div className="mt-8 flex flex-col gap-12">
                {/* Reading Section (Text on Right, Image on Left) */}
                <div className="flex flex-col md:flex-row-reverse gap-8 items-start">
                    {/* Text */}
                    <div className="md:w-2/3">
                        <h2 className="text-2xl text-right text-accent font-playfair mb-2">My Reading Hobbies~ ✨</h2>
                        <p className="text-secondary text-lg font-rosario text-right">
                    ...
                    <div className="md:w-1/3 flex justify-center items-center">
                        <img
                            ...
                            className="rounded-lg max-w-sm shadow-lg"
                        />
                    </div>
                </div>

                {/* Writing Section (Text on Left, Image on Right) */}
                <div className="flex flex-col md:flex-row gap-8 items-start">
                    {/* Text */}
                    <div className="md:w-2/3">
                        <h2 className="text-2xl text-left text-accent font-playfair mb-2">And My Love for Writing ✒️</h2>
                        <p className="text-secondary text-lg font-rosario">
