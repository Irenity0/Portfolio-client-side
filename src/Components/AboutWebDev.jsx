const AboutWebDev = () => {
    return (
        <section>
            ...
            <br /><br />
            However, after 2021, I got back to web design again and started making ramdom side projects. It was like a side quest to me (now it&apos;s my <strong>main quest</strong>). After school resumed, I again lost my flow and didn&apos;t return until 2023. And hopefully it was my last break from web development. 
            <br /><br />
